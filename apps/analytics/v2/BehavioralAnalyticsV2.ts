...
export interface BehavioralAnalyticsV2Config {
  enabled: boolean;
  version: string;
...
export class BehavioralAnalyticsV2 {
  private config: BehavioralAnalyticsV2Config;
  private initialized: boolean = false;

  constructor(config: BehavioralAnalyticsV2Config) {
    this.config = {
      ...config,
      metadata: {
  ...
  public getConfig(): BehavioralAnalyticsV2Config {
    return { ...this.config };
  }
}
