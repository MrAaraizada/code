package com.material.devicemanagementv2
...
fun DeviceManagementV2(
    ...
    Column(
        ...
        if (enabled) {
            Text(
                text = "DeviceManagementV2 Component",
...
data class DeviceManagementV2Config(
