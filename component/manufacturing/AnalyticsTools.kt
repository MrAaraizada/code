...
/**
 * AnalyticsTools - Advanced Compose Component
...
data class AnalyticsToolsState(
...
fun AnalyticsTools(
    ...
    var state by remember { mutableStateOf(AnalyticsToolsState()) }
