package com.material.statemanagementv2
...
fun StateManagementV2(
    ...
    Column(
        ...
        if (enabled) {
            Text(
                text = "StateManagementV2 Component",
...
data class StateManagementV2Config(
