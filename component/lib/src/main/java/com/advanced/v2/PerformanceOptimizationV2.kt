package com.material.performanceoptimizationv2
...
/**
 * PerformanceOptimizationV2 component
...
fun PerformanceOptimizationV2(
    ...
    Column(
        ...
        if (enabled) {
            Text(
                text = "PerformanceOptimizationV2 Component",
...
data class PerformanceOptimizationV2Config(
