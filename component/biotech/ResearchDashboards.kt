...
/**
 * ResearchDashboards - Advanced Compose Component
...
data class ResearchDashboardsState(
...
@Composable
fun ResearchDashboards(
    modifier: Modifier = Modifier,
    onAction: ((String) -> Unit)? = null
) {
    var state by remember { mutableStateOf(ResearchDashboardsState()) }
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "ResearchDashboards Component",
