...
/**
 * CommandInterfaces - Advanced Compose Component
...
data class CommandInterfacesState(
...
@Composable
fun CommandInterfaces(
    modifier: Modifier = Modifier,
    onAction: ((String) -> Unit)? = null
) {
    var state by remember { mutableStateOf(CommandInterfacesState()) }
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "CommandInterfaces Component",
