...
/**
 * PatientInterfaces - Advanced Compose Component
...
data class PatientInterfacesState(
...
@Composable
fun PatientInterfaces(
    modifier: Modifier = Modifier,
    onAction: ((String) -> Unit)? = null
) {
    var state by remember { mutableStateOf(PatientInterfacesState()) }
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "PatientInterfaces Component",
