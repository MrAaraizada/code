...
/**
 * StatusDisplays - Advanced Compose Component
...
data class StatusDisplaysState(
...
fun StatusDisplays(
    ...
    var state by remember { mutableStateOf(StatusDisplaysState()) }
