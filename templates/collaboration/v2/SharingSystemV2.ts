...
export class SharingSystemV2 {
  private config: SharingSystemV2Config;
  private initialized: boolean = false;

  constructor(config: SharingSystemV2Config) {
    this.config = {
      ...config,
      metadata: {
  ...
  public getConfig(): SharingSystemV2Config {
    return { ...this.config };
  }
}

export default SharingSystemV2;
