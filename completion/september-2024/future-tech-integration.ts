...
export interface future-tech-integrationEvents {
  initialized: { timestamp: string; config: future-tech-integrationConfig };
  executed: { result: any; duration: number; params: any };
  error: { error: Error; context: any; timestamp: string };
  configUpdated: { oldConfig: future-tech-integrationConfig; newConfig: future-tech-integrationConfig };
...
export class future-tech-integration {
  ...
  private listeners: Map<keyof future-tech-integrationEvents, Function[]> = new Map();
  ...
  public on<K extends keyof future-tech-integrationEvents>(
    event: K, 
    callback: (data: future-tech-integrationEvents[K]) => void
  ): void {
  ...
  private emit<K extends keyof future-tech-integrationEvents>(
    event: K, 
    data: future-tech-integrationEvents[K]
  ): void {
