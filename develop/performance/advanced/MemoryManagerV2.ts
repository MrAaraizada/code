...
export interface MemoryManagerV2Config {
  enabled: boolean;
  version: string;
...
export class MemoryManagerV2 {
  private config: MemoryManagerV2Config;
  private initialized: boolean = false;

  constructor(config: MemoryManagerV2Config) {
    this.config = {
      ...config,
      metadata: {
  ...
  public getConfig(): MemoryManagerV2Config {
    return { ...this.config };
  }
}

export default MemoryManagerV2;
