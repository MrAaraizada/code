...
export interface ProfilerV2Config {
  enabled: boolean;
  version: string;
...
export class ProfilerV2 {
  private config: ProfilerV2Config;
  private initialized: boolean = false;

  constructor(config: ProfilerV2Config) {
    this.config = {
      ...config,
      metadata: {
  ...
  public getConfig(): ProfilerV2Config {
    return { ...this.config };
  }
}

export default ProfilerV2;
